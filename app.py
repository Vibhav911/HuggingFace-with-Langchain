...
with st.sidebar:
    hf_token = st.text_input("Enter your HuggingFace Token", value="", type="password")
...
llm = HuggingFaceEndpoint(repo_id=repo_id, task="text-generation", max_length=150, temperature=0.7, token=hf_token)
prompt_template = """
